...
export default async function InstallmentSchedulePage({params}:{params:{id:string}}){
 const snap = await adminDb.collection('installmentSchedules').where('installmentPlanId','==',params.id).get();
